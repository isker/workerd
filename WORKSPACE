...
http_archive(
    name = "capnp-cpp",
    integrity = "sha256-jHDvZFoIYhwqjSHeI6UoLMiIJANo9GJEx2LDxb6JwWE=",
    strip_prefix = "capnproto-capnproto-5c28989/c++",
    type = "tgz",
    urls = ["https://github.com/capnproto/capnproto/tarball/5c289892ba5a3a098d1df1d7acf4ab28f013ff91"],
)
...
http_archive(
    ...
    integrity = "sha256-Qn3bcE58J6N5LCkhsd0fovqMwqH3i6IYJpaWylrKPD4=",
    strip_prefix = "v8-12.7.224.11",
    url = "https://github.com/v8/v8/archive/refs/tags/12.7.224.11.tar.gz",
)
